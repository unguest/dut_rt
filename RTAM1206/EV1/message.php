...
<head>
    ...
    <title>Message - Arthur Pons</title>
...
<?php
    ...
    if (isset($_POST["name"]) && isset($_POST["surname"]) && isset($_POST["email"]) && isset($_POST["message"])) {
        $message = $_POST["name"] . " " . $_POST["surname"] . "  [".$_POST["email"]."] : " . $_POST["message"] . PHP_EOL;
    ...
    ?>
    <main>
    <p id="thanks">Message envoyé !</p>
    <p>Cette carte n'a aucune autre utilité que celle de remplir les demandes du DM...</p>
