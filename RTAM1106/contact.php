    ...
    <div class="menu">
        ...
        <main>
            ...
            <form action="contact.php" method="post">
                ...
                <button type="submit" class="red-square-button">Send my message</button>
            </form>
        ...
        <div class="mapped-img">
            <p>While your message is processed, you can play with this map !</p>

            <img src="img/france.png" usemap="#image-map" title="Carte Du Lourd Royaume De Bonne Francie." alt="Carte Du Lourd Royaume De Bonne Francie.">
            ...
            <map name="image-map">
                ...
                <area target="_blank" alt="Région Corse" title="Région Corse" href="https://fr.wikipedia.org/wiki/Front_de_lib%C3%A9ration_nationale_corse" coords="1011,875,970,922,940,996,987,1058,1034,1058,1066,934,1030,878" shape="poly">
